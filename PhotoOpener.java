...
public class PhotoOpener extends JFrame implements ActionListener{
	public static void main(String[] args) {
		new PhotoOpener(args);
	}
...
//		contentPane.add("West",zurückButton);		//weiter/zurück Buttons einfügen
//		zurückButton.addActionListener(this);
//		contentPane.add("East",vorwärtsButton);
//		vorwärtsButton.addActionListener(this);
		pack();
